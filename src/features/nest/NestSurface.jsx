...
export default function NestSurface({ clips, decisionsByClip, collections, allClips, isFirstRun, hasPairedExtension, resolvingClipId, resolveError, onResolve, onOpenAdvanced, onPair, isPairing, onPaste, onIos, onOpenLibrary, onOpenGuide }) {
