...
export default function SearchSurface({ records, clips, collections, missions, onSelectRecord, onSelectCollection, onCreateProject, onCreateWatch, onAsk, onSaveSearch, onExit, focusVersion }) {
