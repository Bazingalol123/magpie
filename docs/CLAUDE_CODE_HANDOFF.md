...
## Extension Side Panel migration (2026-08-16, issue #46, not merged)
...
tab switch, worker-sleep/wake) — see `docs/DECISIONS.md`. No entity,
function, or site deploy needed; ships as `extension-v0.3.0` after merge and
owner approval, tag not yet pushed.
