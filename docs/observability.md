...
Backend diagnostics use structured JSON written by the function runtime. The client receives the same opaque `request_id` in error responses and the `X-Request-Id` response header.
