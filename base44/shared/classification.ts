      ...
      messages: [
        {
          ...
          content: [
            ...
            "Return exactly one JSON object shaped {outcome, existing_collection_id, collection_name, collection_description, schema_fields, record_fields, confidence, reason_codes}.",
